...
void optionsCB(gpointer data)
{
	...
	gtk_toggle_button_set_state(GTK_TOGGLE_BUTTON(button), getBaseMode() == BINARY);
	...
	gtk_toggle_button_set_state(GTK_TOGGLE_BUTTON(button), getBaseMode() == OCTAL);
	gtk_widget_show(button);
	optOctBtn = button;
	...
	gtk_toggle_button_set_state(GTK_TOGGLE_BUTTON(button), getBaseMode() == DECIMAL);
	gtk_widget_show(button);
	optDecBtn = button;
	...
	gtk_toggle_button_set_state(GTK_TOGGLE_BUTTON(button), getBaseMode() == DECIMAL_ENG);
	gtk_widget_show(button);
	optDecEngBtn = button;
	...
	gtk_toggle_button_set_state(GTK_TOGGLE_BUTTON(button), getBaseMode() == HEXADECIMAL);
	gtk_widget_show(button);
	optHexBtn = button;
	...
	gtk_toggle_button_set_state(GTK_TOGGLE_BUTTON(button), getRadixMode() == DEGREES);
	gtk_widget_show(button);
	...
	gtk_toggle_button_set_state(GTK_TOGGLE_BUTTON(button), getRadixMode() == RADIANS);
	gtk_widget_show(button);
	...
	gtk_toggle_button_set_state(GTK_TOGGLE_BUTTON(button), getPolarMode() == RECTANGULAR);
	gtk_widget_show(button);
	...
	gtk_toggle_button_set_state(GTK_TOGGLE_BUTTON(button), getPolarMode() == POLAR);
	gtk_widget_show(button);
	...
	gtk_toggle_button_set_state(GTK_TOGGLE_BUTTON(button), getLCDDispMode() == SHORT_DISPLAY);
	gtk_widget_show(button);
	...
	gtk_toggle_button_set_state(GTK_TOGGLE_BUTTON(button), getLCDDispMode() == LONG_DISPLAY);
	gtk_widget_show(button);
